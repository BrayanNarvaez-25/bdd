...
create table productos_pro_proveedor(
	...
	constraint productos_por_proveedor_pk
...
values(1,'Snacks SA','0992929326');
insert into proveedores(codigo,nombre,telefono)
values(2,'DistriSnacks','098019392');

select * from proveedores

insert into productos_pro_proveedor(pp_codigo_producto,pp_codigo_proveedor,precio)
values(300,1,0.48);
insert into productos_pro_proveedor(pp_codigo_producto,pp_codigo_proveedor,precio)
values(300,2,0.49);
insert into productos_pro_proveedor(pp_codigo_producto,pp_codigo_proveedor,precio)
...
select * from productos_pro_proveedor

select prod.codigo, prod.nombre, prov.nombre, pp.precio from productos prod,proveedores prov,productos_pro_proveedor pp
where pp.pp_codigo_producto = prod.codigo and
pp.pp_codigo_proveedor = prov.codigo and
prod.codigo = 300