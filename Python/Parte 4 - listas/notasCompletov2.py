...
def fnFloat(txtNota,lblError,desde,hasta):
    nota = None
    try:
        nota = float(txtNota.get())
        if nota >= desde and nota <= hasta:
...
def fnGuardar():
    ...
    nota1= fnFloat(txtNota1,lblErrorNota1,0,10)
    nota2 = fnFloat(txtNota2,lblErrorNota2,0,10)
    nota3 = fnFloat(txtNota3,lblErrorNota3,0,10)
    estEncontrado=buscarEstudiante(cedula,estudiantes)
    if estEncontrado == None:
        if (nota1 != None and nota2 != None and nota3 != None) and (nota1 >= 0 and nota1 <= 10 and nota2 >= 0 and nota2 <= 10 and nota3 >= 0 and nota3 <= 10) and (nombre != None and apellido != None and cedula != None):
