...
def fnDeterminarGanador():
    ...
    if valorJugador1>valorJugador2:
        ...
        lblPuntajeJugador1.config(text= puntajeJugador1)
        if puntajeJugador1 == 3:
            lblDadoJugador1.config(image=imagenes[7])
            lblDadoJugador2.config(image=imagenes[8])
        ...
        if puntajeJugador2 == 3:
            lblDadoJugador1.config(image=imagenes[8])
            lblDadoJugador2.config(image=imagenes[7])
    else:
...
imagenes=[
    ...
    obtenerImagen("ganador.png",100),
    obtenerImagen("perdedor.jpg",100)
]
